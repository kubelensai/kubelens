...
import { deleteMutatingWebhookConfiguration } from '@/services/api'

interface DeleteMutatingWebhookModalProps {
  webhook: any
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function DeleteMutatingWebhookModal({
  webhook,
  isOpen,
  onClose,
  onSuccess,
}: DeleteMutatingWebhookModalProps) {
  ...
  const handleDelete = async () => {
    try {
      ...
      await deleteMutatingWebhookConfiguration(webhook.clusterName, webhook.metadata.name)
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-xl transition-all">
                ...
                <div className="px-6 py-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Are you sure you want to delete the mutating webhook configuration{' '}
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>Warning:</strong> Deleting this webhook will stop mutation of
