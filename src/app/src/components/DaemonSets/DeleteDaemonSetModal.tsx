...
interface DeleteDaemonSetModalProps {
  daemonset: any
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function DeleteDaemonSetModal({
  daemonset,
  isOpen,
  onClose,
  onSuccess,
  ...
  if (!daemonset) {
    console.error('DeleteDaemonSetModal: daemonset is null!')
    return null
  }

  const deleteMutation = useMutation({
    mutationFn: async () => {
      console.log('Deleting daemonset:', daemonset.metadata.name)
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Are you sure you want to delete this daemonset? This action cannot be undone.
                      </p>
                      
                      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4">
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">DaemonSet:</span>
                          ...
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">Ready Pods:</span>
                            <span className="font-medium text-gray-900 dark:text-white">
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-red-700 dark:text-red-400">
                              <ul className="list-disc list-inside space-y-1">
                                <li>All pods managed by this daemonset will be deleted</li>
                                <li>This will remove the daemonset from all nodes</li>
                ...
                {deleteMutation.isError && (
                  <div className="mt-4 rounded-md bg-red-50 dark:bg-red-900/20 p-3">
                    <p className="text-sm text-red-800 dark:text-red-300">
                      Failed to delete daemonset. Please try again.
                    </p>
                  </div>
                )}
              </Dialog.Panel>
