...
interface RestartDaemonSetModalProps {
  daemonset: any
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function RestartDaemonSetModal({
  daemonset,
  isOpen,
  onClose,
  onSuccess,
}: RestartDaemonSetModalProps) {
  const restartMutation = useMutation({
    mutationFn: async () => {
      await api.post(
        `/clusters/${daemonset.clusterName}/namespaces/${daemonset.metadata.namespace}/daemonsets/${daemonset.metadata.name}/restart`
      )
    },
    onSuccess: () => {
      onSuccess()
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Are you sure you want to restart this daemonset?
                      </p>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">Desired Pods:</span>
                            <span className="font-medium text-gray-900 dark:text-white">
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-blue-700 dark:text-blue-400">
                              <ul className="list-disc list-inside space-y-1">
                                ...
                                <li>Pods will restart according to the update strategy</li>
                                <li>New pods will use the latest configuration</li>
                                <li>One pod per node will be restarted</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                ...
                {restartMutation.isError && (
                  <div className="mt-4 rounded-md bg-red-50 dark:bg-red-900/20 p-3">
                    <p className="text-sm text-red-800 dark:text-red-300">
                      Failed to restart daemonset. Please try again.
                    </p>
                  </div>
                )}
              </Dialog.Panel>
