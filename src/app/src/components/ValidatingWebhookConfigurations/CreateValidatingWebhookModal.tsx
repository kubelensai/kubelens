...
import { createValidatingWebhookConfiguration } from '@/services/api'

interface CreateValidatingWebhookModalProps {
  clusterName: string
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function CreateValidatingWebhookModal({
  clusterName,
  isOpen,
  onClose,
  onSuccess,
}: CreateValidatingWebhookModalProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await createValidatingWebhookConfiguration(clusterName, webhook)
                ...
                <div className="px-6 py-4 space-y-4">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1 list-disc list-inside">
                      ...
                      <li>Operations: CREATE, UPDATE, DELETE</li>
