                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      ...
                      <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="text-sm font-bold text-gray-900 dark:text-gray-300 truncate">
                          {role.metadata?.name}
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Aggregation Rule - Roles don't have aggregation */}
                    {false && role.aggregationRule && (
                      <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 border border-purple-200 dark:border-purple-800">
                        <h3 className="text-sm font-semibold text-purple-900 dark:text-purple-300 mb-3">
                          Aggregation Rule
                        </h3>
                        <div className="space-y-2">
                          {(role.aggregationRule.clusterRoleSelectors || []).map((selector: any, i: number) => (
