...
interface DeleteCronJobModalProps {
  cronjob: any
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function DeleteCronJobModal({
  cronjob,
  isOpen,
  onClose,
  onSuccess,
  ...
  if (!cronjob) {
    console.error('DeleteCronJobModal: cronjob is null!')
    return null
  }

  const deleteMutation = useMutation({
    mutationFn: async () => {
      console.log('Deleting cronjob:', cronjob.metadata.name)
                      ...
                      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4">
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">CronJob:</span>
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-red-700 dark:text-red-400">
                              <ul className="list-disc list-inside space-y-1">
                                <li>All pods managed by this cronjob will be deleted</li>
                ...
                {deleteMutation.isError && (
                  <div className="mt-4 rounded-md bg-red-50 dark:bg-red-900/20 p-3">
                    <p className="text-sm text-red-800 dark:text-red-300">
                      Failed to delete cronjob. Please try again.
                    </p>
                  </div>
                )}
              </Dialog.Panel>
