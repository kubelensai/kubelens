                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                          ...
                          <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg">
                            ...
                            <div className="text-2xl font-bold text-purple-700 dark:text-purple-300">
                              {job.status.availableReplicas || 0}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      {job.spec.selector?.matchLabels && (
                        <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {Object.entries(job.spec.selector.matchLabels).map(([key, value]) => (
                              <span
                                key={key}
                      ...
                      {job.status.conditions && job.status.conditions.length > 0 && (
                        <div>
                          ...
                          <div className="space-y-2">
                            {job.status.conditions.map((condition: any, index: number) => (
                              <div
                                key={index}
