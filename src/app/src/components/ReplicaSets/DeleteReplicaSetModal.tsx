...
interface DeleteReplicaSetModalProps {
  replicaset: any
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function DeleteReplicaSetModal({
  replicaset,
  isOpen,
  onClose,
  onSuccess,
}: DeleteReplicaSetModalProps) {
  if (!replicaset) {
    console.error('DeleteReplicaSetModal: replicaset is null!')
    return null
  }

  const deleteMutation = useMutation({
    mutationFn: async () => {
      console.log('Deleting replicaset:', replicaset.metadata.name)
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Are you sure you want to delete this replicaset? This action cannot be undone.
                      </p>
                      
                      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4">
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-400">ReplicaSet:</span>
                          ...
                          <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-red-700 dark:text-red-400">
                              <ul className="list-disc list-inside space-y-1">
                                <li>All pods managed by this replicaset will be deleted</li>
                ...
                {deleteMutation.isError && (
                  <div className="mt-4 rounded-md bg-red-50 dark:bg-red-900/20 p-3">
                    <p className="text-sm text-red-800 dark:text-red-300">
                      Failed to delete replicaset. Please try again.
                    </p>
                  </div>
                )}
              </Dialog.Panel>
