...
import MutatingWebhookDetailsModal from '@/components/MutatingWebhookConfigurations/MutatingWebhookDetailsModal'
import EditMutatingWebhookYAMLModal from '@/components/MutatingWebhookConfigurations/EditMutatingWebhookYAMLModal'
import DeleteMutatingWebhookModal from '@/components/MutatingWebhookConfigurations/DeleteMutatingWebhookModal'
...
export default function MutatingWebhookConfigurations() {
  ...
  const { columnWidths, handleMouseDown: handleResizeStart } = useResizableColumns({
    ...
    age: 120,
    actions: 150,
  }, 'mutatingwebhooks-column-widths')
  ...
  const {
    ...
    hasNextPage,
    hasPreviousPage,
  } = usePagination(sortedWebhooks, 10, 'mutatingwebhookconfigurations')
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold gradient-text">Mutating Webhook Configurations</h1>
                ...
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="ml-3 text-gray-500 dark:text-gray-400">Loading mutating webhook configurations...</span>
                    </div>
                  </td>
                </tr>
              ) : webhooks.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center">
                    <p className="text-gray-500 dark:text-gray-400">
                      {filterText ? 'No mutating webhook configurations found matching your filter' : 'No mutating webhook configurations found'}
                    </p>
                  </td>
                </tr>
              ) : (
