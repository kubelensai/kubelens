...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex relative">
      ...
      >
        {darkMode ? (
          <SunIcon className="h-5 w-5 text-yellow-400 group-hover:rotate-180 transition-transform duration-500" />
        ) : (
          <MoonIcon className="h-5 w-5 text-gray-700 group-hover:rotate-12 transition-transform duration-300" />
        )}
      </button>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-white">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold">Kubelens</span>
          </div>
          ...
          <p className="text-xl text-white/90 mb-8 max-w-md leading-relaxed">
            Monitor, manage, and optimize your Kubernetes clusters with an intuitive, powerful interface.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
        <div className="w-full max-w-md">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-red-700 dark:text-red-400">
                      {(loginMutation.error as any)?.response?.data?.error || 'Invalid email or password. Please try again.'}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link
              to="/signup"
              className="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors inline-flex items-center gap-1"
            >
